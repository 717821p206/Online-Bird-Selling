...
function ThirdBird(){
  ...
  <div class="carousel-item  active" interval={50} >
           <img class="d-block " src="https://i.shgcdn.com/80046cea-2a82-4ab6-879a-c1e3e089e9f4/-/format/auto/-/preview/3000x3000/-/quality/lighter/"  alt="Blue and gold macaw" />
       </div>
       <div class="carousel-item " interval={50}>
           <img class="d-block "  src="https://inaturalist-open-data.s3.amazonaws.com/photos/6178436/large.jpg" alt="Blue and gold macaw" />
       </div>
       <div class="carousel-item " interval={50}>
           <img class="d-block "  src="https://www.thealexandriazoo.com/images/animals/BlueAndGoldMacaw.jpg"  alt="Blue and Gold Macaw" />
       </div>
