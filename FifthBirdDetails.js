...
function FifthBird(){
  ...
  <div class="carousel-item  active" interval={5} >
           <img class="d-block "  src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/308065631/1800"  alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={5}>
           <img class="d-block "  src="https://falcones.co.uk/wp-content/uploads/2017/06/Pigeon-.jpg" alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={5}>
           <img class="d-block "  src="https://fromhousetohomeblog.files.wordpress.com/2011/07/pigeons.jpg" alt="Yellow Fischer Love Bird" />
       </div>
