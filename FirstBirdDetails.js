...
function FirstBird(){
  ...
  <div class="carousel-item  active" interval={5} >
           <img class="d-block "  src="https://i0.wp.com/www.birdbaron.com/wp-content/uploads/2019/10/how-many-types-of-lovebird-are-there_.jpg?fit=1200%2C800&ssl=1"  alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={5}>
           <img class="d-block "  src="https://a-z-animals.com/media/2022/06/Lovebird-in-cage.jpg" alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={5}>
           <img class="d-block "  src="https://media.hswstatic.com/eyJidWNrZXQiOiJjb250ZW50Lmhzd3N0YXRpYy5jb20iLCJrZXkiOiJnaWZcL055YXNhLWxvdmViaXJkLmpwZyIsImVkaXRzIjp7InJlc2l6ZSI6eyJ3aWR0aCI6ODI4fX19" alt="Yellow Fischer Love Bird" />
       </div>
