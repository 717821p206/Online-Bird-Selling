...
function SecondBird(){
  ...
  <div class="carousel-item  active" interval={5} >
           <img class="d-block "  src="https://qph.cf2.quoracdn.net/main-qimg-896a30881b647e94e145e418599159f2-lq"  alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={5}>
           <img class="d-block "  src="https://www.thesprucepets.com/thmb/mM9ajuBgNAAs-2QvuEn8KnIMn9E=/5200x0/filters:no_upscale():strip_icc()/two-white-cockatooes-643467100-db35b6ee10af4e579f7b77683d0b7fda.jpg" alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={5}>
           <img class="d-block "  src="https://s3.animalia.bio/animals/photos/full/1.25x1/sulphur-crested-cockatoo-perfect-profile.webp" alt="Yellow Fischer Love Bird" />
       </div>
