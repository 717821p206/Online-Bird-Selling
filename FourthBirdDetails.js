...
function FourthBird(){
  ...
  <div class="carousel-item  active" interval={50} >
           <img class="d-block "  src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/123646541/1800"  alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={50}>
           <img class="d-block "  src="https://rukminim2.flixcart.com/image/850/1000/kjuby4w0/poster/8/i/g/medium-44501-birds-poster-zebra-finch-bird-wall-poster-poster-original-imafzbj6kdqkjam8.jpeg?q=90" alt="Yellow Fischer Love Bird" />
       </div>
       <div class="carousel-item " interval={50}>
           <img class="d-block "  src="https://cdn.download.ams.birds.cornell.edu/api/v1/asset/123646521/1800" alt="Yellow Fischer Love Bird" />
       </div>
